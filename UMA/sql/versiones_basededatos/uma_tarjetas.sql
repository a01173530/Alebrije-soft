...
--
-- Stand-in structure for view `cantidad_plantas`
...
(7, 'Mammillaria herrerae', 'uploads\\M_herrerae.jpeg'),
(8, 'Mammillaria longimamma', 'uploads\\M_longimamma.JPG'),
(9, 'Mammillaria nana', 'uploads\\M_nana.jpeg'),
(10, 'Mammillaria parkinsonii', 'uploads\\M_parkinsonii.jpeg'),
...
('2021-06-21 18:50:27', 9, 1),
('2021-06-21 18:50:27', 10, 1);
...
(9, '2021-06-21 18:50:27', 7, 2, 1),
(10, '2021-06-21 18:52:14', 2, 2, 1);
...
--
-- Stand-in structure for view `lotes_semillas`
-- (See below for the actual view)
--
...
('2021-06-07 21:13:58', 14, 1),
('2021-06-07 21:13:58', 15, 1),
('2021-06-09 07:58:40', 16, 1),
('2021-06-09 07:58:40', 17, 1),
('2021-06-09 07:58:40', 18, 1),
('2021-06-09 08:02:57', 19, 6),
('2021-06-09 08:03:45', 20, 8),
('2021-06-09 08:03:45', 21, 8),
('2021-06-09 08:03:45', 22, 8),
('2021-06-09 08:03:45', 23, 8),
('2021-06-09 12:47:19', 24, 1),
('2021-06-09 12:47:19', 25, 1);
...
(20, '2021-06-09 07:59:10', 7, 4, 1),
(21, '2021-06-09 07:59:10', 7, 4, 1),
(22, '2021-06-09 07:59:10', 7, 4, 1),
(23, '2021-06-09 07:59:10', 7, 4, 1),
(24, '2021-06-09 07:59:10', 7, 4, 1),
(25, '2021-06-21 17:22:50', 6, 4, 1),
(26, '2021-06-21 17:31:45', 1, 4, 1),
(27, '2021-06-21 17:30:44', 10, 4, 1),
(28, '2021-06-21 17:27:46', 5, 4, 1),
(29, '2021-06-21 17:27:46', 5, 4, 1),
(30, '2021-06-21 17:28:54', 6, 4, 1),
(31, '2021-06-21 17:28:54', 6, 4, 1);
...
(14, '2021-06-07 21:13:58', 6, 4, 1),
(15, '2021-06-07 21:13:58', 6, 4, 1),
(16, '2021-06-09 07:58:40', 7, 4, 1),
(17, '2021-06-09 07:58:40', 7, 4, 1),
(18, '2021-06-09 07:58:40', 7, 4, 1),
(19, '2021-06-09 08:02:57', 6, 4, 1),
(20, '2021-06-09 08:03:45', 5, 4, 1),
(21, '2021-06-09 08:03:45', 5, 4, 1),
(22, '2021-06-09 08:03:45', 5, 4, 1),
(23, '2021-06-09 08:03:45', 5, 4, 1),
(24, '2021-06-21 17:02:22', 9, 4, 1),
(25, '2021-06-09 12:48:05', 9, 4, 1);
...
('2021-06-09 07:59:10', 20, 1),
('2021-06-09 07:59:10', 21, 1),
('2021-06-09 07:59:10', 22, 1),
('2021-06-09 07:59:10', 23, 1),
('2021-06-09 07:59:10', 24, 1),
('2021-06-21 17:22:50', 25, 1),
('2021-06-21 17:22:50', 26, 1),
('2021-06-21 17:23:15', 27, 1),
('2021-06-21 17:27:46', 28, 2),
('2021-06-21 17:27:46', 29, 2),
('2021-06-21 17:28:54', 30, 2),
('2021-06-21 17:28:54', 31, 2);
...
,`cantidadPlantas` bigint(21)
,`cantidadLotesPlantulas` bigint(21)
,`cantidadLotesSemillas` bigint(21)
,`imagen` varchar(300)
);
...
--
-- Structure for view `cantidad_plantas`
--
...
--
-- Structure for view `lotes_semillas`
--
...
--
ALTER TABLE `lotesemillas_especie`
  MODIFY `loteSemillaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `plantamadre_especie`
  MODIFY `plantaMadreID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `plantas`
--
ALTER TABLE `plantas`
  MODIFY `plantaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `zonas`
  MODIFY `zonaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `loteplantula_especie`
  ADD CONSTRAINT `loteplantula_especie_ibfk_1` FOREIGN KEY (`lotePlantulaID`) REFERENCES `lotesplantula` (`lotePlantulaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `loteplantula_especie_ibfk_2` FOREIGN KEY (`EspID`) REFERENCES `especie` (`EspID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `lotesemillas_especie`
--
ALTER TABLE `lotesemillas_especie`
  ADD CONSTRAINT `lotesemillas_especie_ibfk_1` FOREIGN KEY (`loteSemillaID`) REFERENCES `lotessemillas` (`loteSemillaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lotesemillas_especie_ibfk_2` FOREIGN KEY (`EspID`) REFERENCES `especie` (`EspID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `lotesplantula`
--
ALTER TABLE `lotesplantula`
  ADD CONSTRAINT `lotesplantula_ibfk_1` FOREIGN KEY (`trasladoID`) REFERENCES `traslado` (`trasladoID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lotesplantula_ibfk_2` FOREIGN KEY (`zonaID`) REFERENCES `zonas` (`zonaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lotesplantula_ibfk_3` FOREIGN KEY (`cuentaID`) REFERENCES `cuentas` (`cuentaID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `lotessemillas`
--
ALTER TABLE `lotessemillas`
  ADD CONSTRAINT `lotessemillas_ibfk_1` FOREIGN KEY (`trasladoID`) REFERENCES `traslado` (`trasladoID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lotessemillas_ibfk_2` FOREIGN KEY (`zonaID`) REFERENCES `zonas` (`zonaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lotessemillas_ibfk_3` FOREIGN KEY (`cuentaID`) REFERENCES `cuentas` (`cuentaID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `permisos_roles`
--
ALTER TABLE `permisos_roles`
  ADD CONSTRAINT `permisos_roles_ibfk_1` FOREIGN KEY (`permisosID`) REFERENCES `permisos` (`permisosID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `permisos_roles_ibfk_2` FOREIGN KEY (`rollID`) REFERENCES `roles` (`rollID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `plantamadre_especie`
--
ALTER TABLE `plantamadre_especie`
  ADD CONSTRAINT `plantamadre_especie_ibfk_1` FOREIGN KEY (`plantaMadreID`) REFERENCES `plantasmadre` (`plantaMadreID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `plantamadre_especie_ibfk_2` FOREIGN KEY (`EspID`) REFERENCES `especie` (`EspID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `plantas`
--
ALTER TABLE `plantas`
  ADD CONSTRAINT `plantas_ibfk_1` FOREIGN KEY (`trasladoID`) REFERENCES `traslado` (`trasladoID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `plantas_ibfk_2` FOREIGN KEY (`zonaID`) REFERENCES `zonas` (`zonaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `plantas_ibfk_3` FOREIGN KEY (`cuentaID`) REFERENCES `cuentas` (`cuentaID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `plantasmadre`
--
ALTER TABLE `plantasmadre`
  ADD CONSTRAINT `plantasmadre_ibfk_1` FOREIGN KEY (`trasladoID`) REFERENCES `traslado` (`trasladoID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `plantasmadre_ibfk_2` FOREIGN KEY (`zonaID`) REFERENCES `zonas` (`zonaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `plantasmadre_ibfk_3` FOREIGN KEY (`cuentaID`) REFERENCES `cuentas` (`cuentaID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `planta_especie`
--
ALTER TABLE `planta_especie`
  ADD CONSTRAINT `planta_especie_ibfk_1` FOREIGN KEY (`plantaID`) REFERENCES `plantas` (`plantaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `planta_especie_ibfk_2` FOREIGN KEY (`EspID`) REFERENCES `especie` (`EspID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `roles_cuentas`
--
ALTER TABLE `roles_cuentas`
  ADD CONSTRAINT `roles_cuentas_ibfk_1` FOREIGN KEY (`rollID`) REFERENCES `roles` (`rollID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `roles_cuentas_ibfk_2` FOREIGN KEY (`cuentaID`) REFERENCES `cuentas` (`cuentaID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
